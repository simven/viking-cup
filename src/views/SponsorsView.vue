...
const sponsors = ref<{ name: string, desc: string, src: string, alt: string, links: SponsorLink[] }[]>([
  ...
  { name: 'FAB Motorsport', desc: 'Atelier de réparation automobile spécialisé dans les véhicules allemands.', src: '/img/fab.webp', alt: 'FAB///Motorsport', links: [{ icon: ['fab', 'facebook-f'], url: 'https://www.facebook.com/fabmotorsport14' }] },
  { name: 'Assurances Lestienne', desc: 'Agence d\'assurance spécialisée dans les sports mécaniques et loisirs motorisés.', src: '/img/lestienne.webp', alt: 'Assurances Lestienne', links: [{ icon: ['fa', 'link'], url: 'https://www.assurances-lestienne.com' }, { icon: ['fab', 'facebook-f'], url: 'https://www.facebook.com/p/Assurances_lestienne-100046798486710' }] },
  // { name: 'NDTC Reprog', desc: 'Reprogrammation moteur en Normandie.', src: '/img/ndtc.webp', alt: 'NDTC Reprog', links: [{ icon: ['fab', 'facebook-f'], url: 'https://www.facebook.com/ndtcreprog' }, { icon: ['fab', 'instagram'], url: 'https://www.instagram.com/ndtc_reprog' }] },
]);
